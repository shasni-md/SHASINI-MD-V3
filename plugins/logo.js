...
const caption = `*MADE BY SHASNI-MD*`
...
if(!q) return reply("*_enter your logo name💀 උදා:- .logo SHASNI-MD._*")

let logoMsg = `*LOGO MAKER BY SHASNI-MD🫣❤️*
...
const fdChannel = {
          ...
          const msgBody = {
            image: {url:`https://i.ibb.co/66xMbPZ/2295.jpg`},
            caption: logoMsg,
